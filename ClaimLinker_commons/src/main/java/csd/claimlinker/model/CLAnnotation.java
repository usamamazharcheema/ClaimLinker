...
public class CLAnnotation {
	private String text;
	private String tweetTextlabels;
	...
	public CLAnnotation(String text, String tweetTextlabels, int position, int tokenEndPosition, int sentencePosition, Association_type associationtype) {
		this.text = text;
		this.tweetTextlabels = tweetTextlabels;
	...
	public Map<String, Object> toObject() {
		...
		objectMap.put("tweetTextlabels", this.tweetTextlabels);
	...
	public String getTweetTextlabels() {
		return tweetTextlabels;
	}
